...
def create_mtcnn_net(image, mini_lp_size, p_model_path=None, o_model_path=None):
    ...
    if p_model_path is not None:
        ...
        bboxes = detect_pnet(pnet, image, mini_lp_size)
    ...
    if o_model_path is not None:
        ...
        bboxes = detect_onet(onet, image, bboxes)

    return bboxes

def detect_pnet(pnet, image, min_lp_size):
    ...
    with torch.no_grad():
        ...
        for scale in scales:
            ...
            img = torch.FloatTensor(preprocess(img))
...
def detect_onet(onet, image, bboxes):
...
if __name__ == '__main__':
    ...
    "test image path", default="test/8.jpg", type=str)
    ...
    bboxes = create_mtcnn_net(image, args.mini_lp, p_model_path='weights/pnet_Weights.pth', o_model_path='weights/onet_Weights.pth')
    ...
    cv2.imwrite('test_show4.jpg', image)
